...
$sql = "select athlete_ID, athlete_name, athlete_box from tbl_athlete where athlete_ID = ?";
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        <li class="active">
                            ...
                            <a data-toggle="collapse" href="#host" aria-expanded="true">
                                <i class="material-icons">content_paste</i>
                                <p>For Competition Hosts
                                    <b class="caret"></b>
                                </p>
                            </a>
                        ...
                        <li>
                            ...
                            <div class="collapse out" id="athlete">
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="./hostCompetitions">Competitions</a>
                                    </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form name ="athleteData" role="form" action="updateAthlete.php" method="POST" >

                                        <div class="form-group label-floating">
                                            <label class="control-label">Athlete Name</label>
                                            <input type="text" name="athleteName"  class="form-control" value="<?php echo $athleteName ?>" required>
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>

                                        <div class="form-group label-floating">
                                            <label class="control-label">Athlete Box</label>
                                            <input type="text" name="athleteBox"  class="form-control" value="<?php echo $athleteBox ?>" required>
                                            <!--<p class="help-block">Example block-level help text here.</p>-->
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="athleteID" value="<?php echo $athleteID ?>" class="form-control" >
