                ...
                <nav class="navbar navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#"> NEW DIVISION </a>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form name ="divisionData" role="form" action="inputDiv.php" method="POST" >
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <label>Division is Team<input type="checkbox" name="divIsTeam" id="divIsTeam" class="form-control" onchange="toggleCheckbox(this)">
                                                </label>
                                                <!--<p class="help-block">Example block-level help text here.</p>-->
                                            </div>
                                            <div class="form-group" id="teamSize">
                                                <label>Team Size</label>
                                                <select class="form-control" style="width:100px;" name="teamSize">
