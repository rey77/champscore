                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center">
                                ...
                                <h5 class="description">As an Athlete, you have possibilites to browse and register for your next Competitions</h5>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center">
                                <a class="btn btn-lg btn-pinterest"  href = "athleteAllCompetitions.php" >
                                    <i class="material-icons">public</i> Browse Competitions
                                </a>
                                <a class="btn btn-lg btn-pinterest"  href = "athleteCompetitions.php" >
