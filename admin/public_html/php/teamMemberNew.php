...
if ($fromWhere == 'edit') {
    ...
    $lastTeamID = $_POST['teamID'];

    $sql = "select team_ID, team_name, team_box from tbl_team where team_ID = ?";
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $q = $pdo->prepare($sql);
    $q->execute(array($lastTeamID));


    while ($zeile = $q->fetch(/* PDO::FETCH_ASSOC */)) {

        $teamName = $zeile['team_name'];
        $teamBox = $zeile['team_box'];
    }
} else {
    ...
    $sql = "INSERT INTO `tbl_team` ( `team_name`, `team_box`) VALUES (?,?)";
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $q = $pdo->prepare($sql);
    $q->execute(array($teamName, $teamBox));

    $lastTeamID = $pdo->lastInsertId();

    $sql = "INSERT INTO `tbl_team_division` ( `fk_team_ID`, `fk_div_ID`) VALUES (?,?)";
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $q = $pdo->prepare($sql);
    $q->execute(array($lastTeamID, $divID));
}
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form name ="teamData" role="form" action="inputTeamMember.php" method="POST" >
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="teamMemberName" class="form-control" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="teamID" value="<?php echo $lastTeamID ?>" class="form-control" >
