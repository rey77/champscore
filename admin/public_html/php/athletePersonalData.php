    ...
    <head>
        ...
        <script>
            ...
            function setCountryGender() {
                ...
                document.getElementById("country").value = "<?php echo $athleteCountry ?>";

                if (<?php echo $athleteGender ?> === 1) {
            ...
            function mySubmitAthleteData()
            {

                var filename = <?php echo $_SESSION['athlete_id']; ?> + ".jpg";

                var formData = new FormData();
                formData.append('fileToUpload', $('#fileToUpload')[0].files[0], filename);
                formData.append('actionPicture', $('#actionPicture')[0].files[0], filename);
                formData.append('lastname', document.getElementById('athleteLastName').value);
                formData.append('firstname', document.getElementById('athleteFirstName').value);
                formData.append('street', document.getElementById('athleteStreet').value);
                formData.append('zip', document.getElementById('athleteZip').value);
                formData.append('city', document.getElementById('athleteCity').value);
                formData.append('country', $("#country").val());
                formData.append('affiliate', $("#athleteAffiliate").val());
                formData.append('birthdate', $("#athleteBirthDate").val());
                formData.append('bestscore', document.getElementById('athleteBestScore').value);
                formData.append('shirtsize', document.getElementById('athleteShirtSize').value);
                formData.append('gender', document.querySelector('input[name = "gender" ]:checked').value);


                $.ajax({
                    type: "POST",
                    url: "updateAthleteData.php",
                    cache: false,
                    data: formData,
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <form name ="formAthleteData" role="form" enctype="multipart/form-data" onsubmit="return mySubmitAthleteData()">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-lg-offset-4 fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail img-circle img-raised">
                                                        <img src="<?php echo $avatarsrc . "?dummy=8484744" ?>" alt="...">
                                                    </div>

                                                    <div class="fileinput-preview fileinput-exists thumbnail img-circle img-raised"></div>
                                                    <h4 class="card-title"><?php echo $athleteFirstname . " " . $athleteLastname ?></h4>
                                                    <p class="description">
                                                    ...
                                                    <div>
                                                        <span class="btn btn-raised btn-round btn-oxfordblue btn-file">
                                                            ...
                                                            <input type="file"  name="fileToUpload" id="fileToUpload" value="<?php echo $avatarsrc ?>"/></span>
                                                        <br />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="email" id="email" class="form-control" value="<?php echo $athleteEmail ?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Affiliate</label>
                                                        <input type="text" id="athleteAffiliate"  class="form-control" value="<?php echo $athleteAffiliate ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" id="athleteFirstName" class="form-control" value="<?php echo $athleteFirstname ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Last Name</label>
                                                        <input type="text" id="athleteLastName" class="form-control" value="<?php echo $athleteLastname ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Date of Birth</label>
                                                        <input type="date" id="athleteBirthDate" class="form-control" value=<?php echo $athleteBirthdate ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" id="athleteStreet" class="form-control" value="<?php echo $athleteStreet ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" id="athleteZip" class="form-control" value="<?php echo $athleteZip ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" id="athleteCity" class="form-control" value="<?php echo $athleteCity ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" id="athleteShirtSize"  class="form-control" value="<?php echo $athleteShirtsize ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">Personal Best in Competitive Fitness</label>
                                                        <input type="text" id="athleteBestScore"  class="form-control" value="<?php echo $athleteBestScore ?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12" align="center">
                                                    ...
                                                    <div class="col-lg-12 fileinput fileinput-new text-center" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail">
                                                            <img src="<?php echo $athleteActionpictureSrc . "?dummy=8484744" ?>" alt="...">
                                                        </div>
