                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-lg-offset-4 fileinput fileinput-new text-center" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail img-circle img-raised">
                                                        <img src="uploads/athlete/profile/<?php echo $_SESSION['athlete_id'] . ".jpg" ?>" alt="...">
                                                    </div>
                                                    ...
                                                    <div>
                                                        <span class="btn btn-raised btn-round btn-default btn-file">
                                                            ...
                                                            <input type="file"  name="fileToUpload" id="fileToUpload" value="uploads/athlete/profile/<?php echo $_SESSION['athlete_id'] . ".jpg" ?>"/></span>
                                                        <br />
