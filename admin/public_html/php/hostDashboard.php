                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="POST" action='newCompetition.php'>
                                    ...
                                    <button type ="submit" class="btn btn-pinterest" data-toggle="tooltip" data-placement="right" title="Add new Competition" >Competition <i class="material-icons">add</i></button>
                            ...
                            <div class="col-md-4">
                                <div class="card card-product">
                                    ...
                                    <div class="card-footer">
                                        <div class="price">
                                            <h4><?php echo $zeile['comp_date'] ?></h4>
                                        </div>
