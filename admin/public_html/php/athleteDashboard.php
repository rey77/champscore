                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        <li>
                            ...
                            <a data-toggle="collapse" href="#host" aria-expanded="false">
                        ...
                        <li class="active">
                            <a data-toggle="collapse" href="#athlete" aria-expanded="true">
                                <i class="material-icons">content_paste</i>
                                <p>For Athletes
                                    <b class="caret"></b>
                                </p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                <div class="card-header" data-background-color="oxfordblue">
                                    <i class="material-icons">fitness_center</i>
                                </div>
                                <div class="card-content">
                                    <p class="category">Attended Competitions</p>
